...
function darkMode() {
  let selection = document.getElementById('darkMode')

  if (selection.checked) {
    document.documentElement.setAttribute('dark-mode', 'on')
    document.querySelector('.dark-mode label').innerHTML = 'Ligado'
  } else {
    document.documentElement.setAttribute('dark-mode', 'off')
    document.querySelector('.dark-mode label').innerHTML = 'Desligado'
  }
}
